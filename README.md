...
- **Industrial automation & process control** - PLC programming, HMI/SCADA, custom cross platform software development
- **Communication & protocol integration** - industrial protocols, custom protocol bridges/gateways
...
- **Languages**: C/C++, Python, Delphi, FreePascal/Lazarus, JS, HTML, Bash, IEC 61131
...
- **LinkedIn**: [in/zeljkoavramovic](https://www.linkedin.com/in/zeljkoavramovic/)
